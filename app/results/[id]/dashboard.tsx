...
import { BusinessScoreTab } from "./components/business-score/business-score-tab"
import { RecommendationTab } from "./components/recommendation/recommendation-tab"
      ...
      <div className="space-y-8">
        ...
        <Card>
          ...
          <div className="px-6 pb-6">
            ...
            <p className="text-sm text-gray-500 text-center">Map showing laundromats near Arlington, TX</p>
          </div>
        </Card>
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900 flex flex-col">
      ...
      <div ref={headerRef} className="sticky top-0 left-0 right-0 z-40 bg-white shadow-sm">
        ...
        <div className="border-b border-gray-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
            <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Laundromat Acquisition Analysis</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex-grow">
        {activeTab === "score" && (
          <BusinessScoreTab listingId="mock-listing-123" />
        )}

        {activeTab === "recommendation" && (
          <RecommendationTab listingId="mock-listing-123" />
        )}
